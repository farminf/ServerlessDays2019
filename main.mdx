...
<ul>
  <Appear>
    <p style={{ fontSize: "42px" }}>Avoid Manual Resources Creation</p>
    <p style={{ fontSize: "42px" }}>Deployment Environments</p>
    <p style={{ fontSize: "42px" }}>Reusability and Scalability</p>
    <p style={{ fontSize: "42px" }}>Versioning/git</p>
  </Appear>
</ul>
...
<ul>
  <Appear>
    <p style={{ fontSize: "42px" }}> Multi Region </p>
    <p style={{ fontSize: "42px" }}> Best Practices</p>
    <p style={{ fontSize: "42px" }}> Code Completion </p>
    <p style={{ fontSize: "42px" }}> Private Constructs</p>
